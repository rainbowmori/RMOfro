...
import github.rainbowmori.ofro.command.OfroCommand;
import github.rainbowmori.ofro.command.feature.OfroFeatureCommand;
...
public final class Ofro extends RMPlugin {
  ...
  public void onEnable() {
    ...
    registerCommand(new OfroFeatureCommand());
