...
public final class ItemValueShopPage extends PageMenu<Ofro> {

  private final List<MaterialInfo> values;
  private final Component title;

  public ItemValueShopPage(Ofro plugin, Component title, List<MaterialInfo> values) {
    this(plugin, title, values, 0, Math.min(values.size(), 45));
  }

  private ItemValueShopPage(Ofro plugin, Component title, List<MaterialInfo> values,
